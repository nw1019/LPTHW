...
class Scene(object):
	def __init__(self, title, urlname, description, helpdes):
		self.title = title
		self.urlname = urlname
		self.description = description
		self.helpdes = helpdes
		self.paths = {}
...
the_bridge = Scene("The Bridge", "the_bridge",
	...
	""", "type: throw the bomb / slowly place the bomb")
...
Deadmessage = quips[randint(0, len(quips) - 1)]


generic_death = Scene("Death...", "death", Deadmessage, "type: shoot! / dodge! / tell a joke")
